...
import os
import pandas as pd
from Lib.TradingLib.Currency import Currency as Cr
from Lib.Utils import  FileNames
...
class MT4HistoricFile:
    ...
    def collect_datasets(self, pattern):
        """
        Collects the input data set file names
    ...
    def convert(self, file_name):
        ...
        _time_col = [c for c in _df.columns if "Time" in c][0]
        ...
        print("Saving output file",  _out_file_name, "Columns ",  _df.columns)
