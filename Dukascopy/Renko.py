...
class Renko(PriceFileConverter.PriceFileConverter):
    ...
    def __init__(self, config_folder, config_file, input_folder, output_folder, tick_folder, parse):
...
if __name__ == "__main__":
    try:
        ...
        _tick_folder = sys.argv[5]
    except Exception as e:
        raise Exception(str(e))

    print("Processing for", _config_file)

    _rk = Renko(_config_folder, _config_file, _input_folder, _output_folder, _tick_folder, "")
    _rk.run()
