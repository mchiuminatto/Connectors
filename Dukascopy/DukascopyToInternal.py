...
from Lib.Connectors.Dukascopy import DukasCopyFileNameParser as Dfnp
...
class  DukascopyToInternal(PriceFileConverter.PriceFileConverter):
    ...
    def candle_trf_full(self, file_name):
        ...
        Open the data set in the input folder
        Transform it
         Save it in the output folder

        :param file_name: data set's name in the  input folder
        :return:
        """
